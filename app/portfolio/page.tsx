      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-slate-500 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed italic">
            We build the engine that drives your digital business forward.
          </p>
        </div>
              ...
              <div className="p-8 flex flex-col grow">
                ...
                <div className="mt-auto">
                  <a
                    ...
                    className="inline-flex items-center gap-2 text-sm font-bold text-blue-600 hover:gap-4 transition-all"
                  >
        ...
        <section className="relative overflow-hidden bg-blue-600 rounded-[2.5rem] p-8 md:p-14 text-white text-center shadow-xl shadow-blue-200 max-w-5xl mx-auto">
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            ...
            <p className="text-blue-50 text-base md:text-lg mb-10 leading-relaxed font-medium opacity-90">
              Don't leave your project for tomorrow. Let's talk about your
              business goals on WhatsApp right now.
            </p>
